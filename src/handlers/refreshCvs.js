...
module.exports.refreshCvs = async () => {
  ...
  const resp = await got(
    "https://www.cvs.com/immunizations/covid-19-vaccine.vaccine-status.CO.json?vaccineinfo",
    {
      headers: {
        "User-Agent":
  ...
  if (
    resp.body.responsePayloadData &&
    !_.isEmpty(resp.body.responsePayloadData.data)
  ) {

...
module.exports.findPharmacaStores = async () => {
  ...
  const resp = await got.post('https://www.pharmacarx.com/wp-admin/admin-ajax.php', {
    headers: {
    ...
    form: {
      ...
      'options[map_end_icon]': 'https://www.pharmacarx.net/wp-content/plugins/store-locator-le/images/icons/bulb_azure.png',
      'options[map_home_icon]': 'https://www.pharmacarx.net/wp-content/plugins/store-locator-le/images/icons/bulb_yellow.png',

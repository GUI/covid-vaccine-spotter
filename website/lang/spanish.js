...
news: {
  date: "2021/25/03",
  message:
    "<strong>¡Nuevas características!</strong> Filtrar por tipo de vacuna (Moderna, Pfizer, Johnson y Johnson), tipo de cita (primera o segunda dosis), y farmacia. Sé que estas han sido características solicitadas con frecuencia, ¡y por eso espero que te ayuden bien en tu búsqueda de vacunas!",
  suffix:
...
scanningDetails: {
  scanning:
    "Escaneando {chain_count} farmacias ({store_count} tiendas diferentes) en su estado",
},
searchBar: {
  zipTextField: {
...
steps: [
  {
    header:
      "Paso 1: Revise la disponibilidad de su condado y la eligibilidad de su estado",

<template>
  <div class="alert alert-info" role="alert">
    <p class="mb-0">
      <strong>03/30/2021:</strong> <strong>Albertsons</strong> and all of its
      brands (<strong>Safeway</strong>, etc.) are back! 🎉 They currently only
      appear to update appointment availability every 30-60 minutes, but I still
      hope this can help. Any feedback is welcome:
      <a

...
exports.up = function(knex) {
  return knex.schema
    ...
    .createTable('postal_codes', (table) => {
      ...
      table.string('state_code', 2).references('code').inTable('states').notNullable();
    ...
    }).then(() => knex.raw('CREATE TRIGGER postal_codes_updated_at BEFORE UPDATE ON postal_codes FOR EACH ROW EXECUTE PROCEDURE update_timestamp()'));
};

exports.down = function(knex) {
  return knex.schema
    .dropTableIfExists('postal_codes');
};
